...
class GestaoRelatorioAcompanhamentoControllerTest {

    @Mock
    private GestaoRelatorioAcompanhamentoService service;
    ...
    void deveEncaminharFiltroPorNomeDoEstagiario() throws Exception {
        ...
        mockMvc.perform(get("/v1/relatorios-acompanhamento")
                        .param("entidadeId", "40")
                        .param("estagiario", "Joao"))
                .andExpect(status().isOk());

        ArgumentCaptor<RelatorioAcompanhamentoFiltro> captor =
                ArgumentCaptor.forClass(RelatorioAcompanhamentoFiltro.class);
