...
public interface GestaoAssiduidadeService {
    ...
    List<EmpregoDominioOpcaoResponse> listarTiposAssiduidade();

    List<EmpregoDominioOpcaoResponse> listarEstadosAssiduidade();

    List<EmpregoDominioOpcaoResponse> listarDecisoesAssiduidade();
}
