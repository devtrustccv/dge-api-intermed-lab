...
public class PerfilCandidatoAdesaoController {
    ...
    @GetMapping
    public PerfilCandidatoApiResponse<AdesaoJovemResponse> carregarFormulario(
            @RequestParam(required = false) Long pessoaId
    ) {
        return PerfilCandidatoApiResponse.sucesso(
                "Dados para adesão carregados com sucesso.",
                adesaoService.carregarFormulario(pessoaId)
        );
    }
